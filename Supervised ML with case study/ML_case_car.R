# The codings are based on datacamp online course "Supervised Learning in R: Case Studies"
library(tidyverse)

cars2018 <- read_csv('../DataScience/Supervised ML with case study/cars2018.csv')
